...
directory = os.getcwd()
os.chdir(directory)
def run_model_sto(supplycap, supplycost, arccap, arccost, arcmin, dmd, tariff_surc,
    ...
    if Forward12m == False:
        ...
        for i in range(0,len(actual_dates),12):
            ...
            solution = solve_network(ID,d_range,supply,arcs,arc_min_flow,demand,sto_par_df,inj_cost,ext_cost,init_sto_first)
        ...
        for date in act_dates:
            ...
            if date != act_dates[-1]:
                ...
                solution = solve_network(dateID,dateRange,supply,arcs,arc_min_flow,demand,sto_par_df,inj_cost,ext_cost,init_sto_first)
            ...
            # keep the solution for the whole year
                ...
                last_solve = solve_network(dateID,dateRange,supply,arcs,arc_min_flow,demand,sto_par_df,inj_cost,ext_cost,init_sto_first)
...
def solve_network(dateID,dates,supply,arcs,arc_min_flow,demand,sto_par_df,inj_cost,ext_cost,init_sto_first):
    """
