...
directory = os.getcwd()
os.chdir(directory)
def run_model_StoExp_max(supplycap,supplycost,arccap,arccost,arcmin,arcmax,dmd,tariff_surc,
    ...
    if Forward12m == False:
        ...
        for i in range(0,len(actual_dates),12):
            ...
            solution = solve_network(ID,d_range,supply,arcs,arc_min_flow,arc_max_flow,demand,sto_par_df,inj_cost,ext_cost,init_sto_first,export)
        ...
        for date in act_dates:
            ...
            if date != act_dates[-1]:
                ...
                solution = solve_network(dateID,dateRange,supply,arcs,arc_min_flow,arc_max_flow,demand,sto_par_df,inj_cost,ext_cost,init_sto_first,export)
            ...
            # keep the solution for the whole year
                ...
                last_solve = solve_network(dateID,dateRange,supply,arcs,arc_min_flow,arc_max_flow,demand,sto_par_df,inj_cost,ext_cost,init_sto_first,export)
...
def solve_network(dateID,dates,supply,arcs,arc_min_flow,arc_max_flow,demand,sto_par_df,inj_cost,ext_cost,init_sto_first,export):
    """
